...
const BoardFrame = ({
  ...
  return (
    <div className="grid w-full grid-cols-[1.25rem_minmax(0,1fr)] sm:grid-cols-[1.5rem_minmax(0,1fr)]">

      {/* Rank numbers */}
      <div
        className="col-start-1 row-start-1 grid text-[10px] font-bold text-[#D4AF37] sm:text-xs"
        style={{
      ...
      {/* Chess board */}
      <div className="col-start-2 row-start-1 aspect-square w-full overflow-hidden rounded-xl border border-[rgba(212,175,55,0.18)] shadow-2xl shadow-black/30 sm:rounded-2xl">
        <div
      ...
      {/* Alphabet at bottom */}
      <div className="col-start-2 row-start-2 grid grid-cols-8 text-[10px] font-bold text-[#D4AF37] sm:text-xs">
